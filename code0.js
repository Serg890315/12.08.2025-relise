...
gdjs.LobbyCode.asyncCallback15841996 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(43200), (runtimeScene) => (gdjs.LobbyCode.asyncCallback15841996(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15851108);
}
}
if (isConditionTrue_0) {
...
for (var i = 0, k = 0, l = gdjs.LobbyCode.GDBlueButtonObjects1.length;i<l;++i) {
    if ( gdjs.LobbyCode.GDBlueButtonObjects1[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15853132);
}
}
}
if (isConditionTrue_0) {
{gdjs.evtsExt__Telegram__openLink.func(runtimeScene, "https://www.consultant.ru/document/cons_doc_LAW_34661/ddf872bbf0198a5ffe733c85ac8e65649ba9824d/", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
for (var i = 0, k = 0, l = gdjs.LobbyCode.GDGreyButton2Objects1.length;i<l;++i) {
    if ( gdjs.LobbyCode.GDGreyButton2Objects1[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15854476);
}
}
}
if (isConditionTrue_0) {
{gdjs.evtsExt__Telegram__openLink.func(runtimeScene, "https://www.drom.ru/pdd/pdd/", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
