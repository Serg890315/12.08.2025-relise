...
gdjs.PodderCode.asyncCallback22443572 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.PodderCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Potracheno", false);
}gdjs.PodderCode.localVariables.length = 0;
}
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.PodderCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(43200), (runtimeScene) => (gdjs.PodderCode.asyncCallback22443572(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
{gdjs.evtsExt__Telegram__openLink.func(runtimeScene, "https://t.me/+YyeTvHxhpyBjZmVi", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
if (isConditionTrue_0) {
{gdjs.evtsExt__Telegram__openLink.func(runtimeScene, "https://t.me/+NsQGIMHT2yk5MDk6", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
if (isConditionTrue_0) {
{gdjs.evtsExt__Telegram__openLink.func(runtimeScene, "https://webtid.ru/gai", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
gdjs.PodderCode.eventsList1(runtimeScene);
gdjs.PodderCode.GDProekt_9595TelObjects1.length = 0;
gdjs.PodderCode.GDProekt_9595TelObjects2.length = 0;
gdjs.PodderCode.GDGAI_9595RossiiObjects1.length = 0;
gdjs.PodderCode.GDGAI_9595RossiiObjects2.length = 0;
